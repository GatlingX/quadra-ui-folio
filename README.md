...
**Project**: quadra-ui-folio 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a devin-like UI interface, with a console, chat UI, source code and a canvas, in a 2x2 quadrant 
...
```sh
git clone https://github.com/GPT-Engineer-App/quadra-ui-folio.git
cd quadra-ui-folio
npm i
